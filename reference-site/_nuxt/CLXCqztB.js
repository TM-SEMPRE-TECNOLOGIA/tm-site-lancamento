...
function oe(f, n) {
  ...
  if (n === Q || n === he) {
    ...
    if (e === null) {
      ...
      if (a !== void 0) {
        for (let o = 0; o < a.count; o++) r.push(o);
    ...
    if (n === Q)
      ...
      for (let r = 0; r < s; r++)
        r % 2 === 0
          ? (t.push(e.getX(r)), t.push(e.getX(r + 1)), t.push(e.getX(r + 2)))
          : (t.push(e.getX(r + 2)), t.push(e.getX(r + 1)), t.push(e.getX(r)));
    t.length / 3 !== s &&
      console.error(
  ...
  return (
    ...
    s.traverse(function (t) {
      ...
      (i.skeleton = r.skeleton.clone()),
        ...
        (i.skeleton.bones = a.map(function (o) {
          return e.get(o);
        })),
...
function _e(f, n, e) {
  ...
  for (let s = 0; s < f.children.length; s++)
    _e(f.children[s], n.children[s], e);
}
class Vn extends be {
  constructor(n) {
    super(n),
  ...
  load(n, e, s, t) {
    ...
    if (this.resourcePath !== "") r = this.resourcePath;
      ...
      r = G.resolveURL(c, this.path);
    } else r = G.extractUrlBase(n);
    this.manager.itemStart(n);
    const a = function (c) {
        t ? t(c) : console.error(c),
          i.manager.itemError(n),
          i.manager.itemEnd(n);
      },
  ...
  parse(n, e, s, t) {
    ...
    const r = {},
      a = {},
      o = new TextDecoder();
    if (typeof n == "string") i = JSON.parse(n);
    else if (n instanceof ArrayBuffer)
      if (o.decode(new Uint8Array(n, 0, 4)) === Ae) {
        try {
          r[g.KHR_BINARY_GLTF] = new wn(n);
        } catch (l) {
          t && t(l);
          return;
        }
        i = JSON.parse(r[g.KHR_BINARY_GLTF].content);
      } else i = JSON.parse(o.decode(n));
    else i = n;
  ...
  _markDefs() {
    ...
    for (let s = 0, t = e.length; s < t; s++) {
      ...
      i.extensions &&
        ...
        n._addNodeRef(this.cache, i.extensions[this.name].light);
    }
  }
  _loadLight(n) {
    const e = this.parser,
    ...
    if (t) return t;
    const i = e.json,
      o = (((i.extensions && i.extensions[this.name]) || {}).lights || [])[n];
    let c;
    const u = new F(16777215);
    o.color !== void 0 && u.setRGB(o.color[0], o.color[1], o.color[2], w);
  ...
  extendParams(n, e, s) {
    ...
    if (i) {
      if (Array.isArray(i.baseColorFactor)) {
        ...
        n.color.setRGB(r[0], r[1], r[2], w), (n.opacity = r[3]);
      }
      i.baseColorTexture !== void 0 &&
        t.push(s.assignTexture(n, "map", i.baseColorTexture, U));
    }
...
class dn {
  ...
  extendMaterialParams(n, e) {
    const s = A(this.parser, n, this.name);
    return (
      s === null ||
...
class pn {
  ...
  getMaterialType(n) {
    return A(this.parser, n, this.name) !== null ? y : null;
  }
  extendMaterialParams(n, e) {
    const s = A(this.parser, n, this.name);
...
class mn {
  ...
  extendMaterialParams(n, e) {
    const s = A(this.parser, n, this.name);
    return (
      s === null || (e.dispersion = s.dispersion !== void 0 ? s.dispersion : 0),
      Promise.resolve()
    );
  }
}
  ...
  extendMaterialParams(n, e) {
    ...
    return (
      ...
      s.iridescenceTexture !== void 0 &&
        t.push(
          this.parser.assignTexture(e, "iridescenceMap", s.iridescenceTexture)
        ),
...
class Tn {
  ...
  extendMaterialParams(n, e) {
    ...
    const t = [];
    if (
      ((e.sheenColor = new F(0, 0, 0)),
      (e.sheenRoughness = 0),
      (e.sheen = 1),
      s.sheenColorFactor !== void 0)
    ) {
      const i = s.sheenColorFactor;
      e.sheenColor.setRGB(i[0], i[1], i[2], w);
    }
    return (
      ...
      s.sheenColorTexture !== void 0 &&
        t.push(
          this.parser.assignTexture(e, "sheenColorMap", s.sheenColorTexture, U)
        ),
  ...
  extendMaterialParams(n, e) {
    ...
    return (
      ...
      s.transmissionTexture !== void 0 &&
        t.push(
          this.parser.assignTexture(e, "transmissionMap", s.transmissionTexture)
        ),
      Promise.all(t)
    );
  }
...
class En {
  ...
  extendMaterialParams(n, e) {
    ...
    return (
      (e.attenuationColor = new F().setRGB(i[0], i[1], i[2], w)), Promise.all(t)
    );
  }
}
class xn {
...
class _n {
  ...
  extendMaterialParams(n, e) {
    ...
    return (
      (e.specularColor = new F().setRGB(i[0], i[1], i[2], w)),
  ...
  extendMaterialParams(n, e) {
    ...
    return (
      ...
      s.bumpTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, "bumpMap", s.bumpTexture)),
      Promise.all(t)
    );
  }
}
...
class ae {
  ...
  loadBufferView(n) {
    ...
    if (s.extensions && s.extensions[this.name]) {
      const t = s.extensions[this.name],
      ...
      return i.then(function (a) {
        ...
        return r.decodeGltfBufferAsync
          ? r
              .decodeGltfBufferAsync(u, l, h, t.mode, t.filter)
              .then(function (d) {
                return d.buffer;
              })
        ...
        Promise.all(a).then((c) => {
          ...
          for (const p of l) {
            const R = new K(),
              ...
              T = new me(),
              _ = new C(1, 1, 1),
              x = new Ne(p.geometry, p.material, h);
            for (let E = 0; E < h; E++)
              o.TRANSLATION && m.fromBufferAttribute(o.TRANSLATION, E),
                o.ROTATION && T.fromBufferAttribute(o.ROTATION, E),
                o.SCALE && _.fromBufferAttribute(o.SCALE, E),
                x.setMatrixAt(E, R.compose(m, T, _));
            for (const E in o)
              if (E === "_COLOR_0") {
                const M = o[E];
                ...
                E !== "TRANSLATION" &&
                  E !== "ROTATION" &&
                  E !== "SCALE" &&
                  p.geometry.setAttribute(E, o[E]);
            ge.prototype.copy.call(x, p),
...
class Nn {
  ...
  decodePrimitive(n, e) {
    const s = this.json,
      t = this.dracoLoader,
      i = n.extensions[this.name].bufferView,
      r = n.extensions[this.name].attributes,
      a = {},
      o = {},
      c = {};
    for (const u in r) {
    ...
    for (const u in n.attributes) {
      const l = $[u] || u.toLowerCase();
      if (r[u] !== void 0) {
        const h = s.accessors[n.attributes[u]],
          d = k[h.componentType];
...
const L = {
  ...
  ue = { 9728: Re, 9729: J, 9984: He, 9985: ke, 9986: Pe, 9987: Te },
  le = { 33071: ve, 33648: De, 10497: Z },
  q = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 },
  $ = {
    POSITION: "position",
    NORMAL: "normal",
    TANGENT: "tangent",
  ...
  Pn = { CUBICSPLINE: void 0, LINEAR: xe, STEP: tn },
  W = { OPAQUE: "OPAQUE", MASK: "MASK", BLEND: "BLEND" };
function kn(f) {
  return (
    f.DefaultMaterial === void 0 &&
      (f.DefaultMaterial = new Ee({
        color: 16777215,
        emissive: 0,
        metalness: 1,
        roughness: 1,
...
function O(f, n, e) {
  for (const s in e.extensions)
    f[s] === void 0 &&
      ...
      (n.userData.gltfExtensions[s] = e.extensions[s]));
}
function S(f, n) {
  n.extras !== void 0 &&
...
function Hn(f, n, e) {
  ...
  return Promise.all([Promise.all(r), Promise.all(a), Promise.all(o)]).then(
    function (c) {
      const u = c[0],
        l = c[1],
        h = c[2];
      return (
        ...
        t && (f.morphAttributes.normal = l),
        i && (f.morphAttributes.color = h),
...
function vn(f) {
  ...
  if (
    (e
      ? (n = "draco:" + e.bufferView + ":" + e.indices + ":" + Y(e.attributes))
      : (n = f.indices + ":" + Y(f.attributes) + ":" + f.mode),
    f.targets !== void 0)
  )
...
function Y(f) {
  ...
  for (let s = 0, t = e.length; s < t; s++) n += e[s] + ":" + f[e[s]] + ";";
  return n;
}
function ee(f) {
  switch (f) {
...
class Kn {
  constructor(n = {}, e = {}) {
    ...
    if (typeof navigator < "u" && typeof navigator.userAgent < "u") {
      ...
      (t = s && o ? parseInt(o[1], 10) : -1),
        (i = a.indexOf("Firefox") > -1),
        (r = i ? a.match(/Firefox\/([0-9]+)\./)[1] : -1);
    }
    typeof createImageBitmap > "u" || (s && t < 17) || (i && r < 98)
      ? (this.textureLoader = new Oe(this.options.manager))
      : (this.textureLoader = new Ce(this.options.manager)),
      this.textureLoader.setCrossOrigin(this.options.crossOrigin),
      this.textureLoader.setRequestHeader(this.options.requestHeader),
      (this.fileLoader = new de(this.options.manager)),
  ...
  _markDefs() {
    ...
    for (let t = 0, i = e.length; t < i; t++) {
      const r = e[t].joints;
      for (let a = 0, o = r.length; a < o; a++) n[r[a]].isBone = !0;
    }
  ...
  _getNodeRef(n, e, s) {
    ...
    const t = s.clone(),
      i = (r, a) => {
        ...
        for (const [c, u] of r.children.entries()) i(u, a.children[c]);
      };
  ...
  loadBuffer(n) {
    ...
    return new Promise(function (i, r) {
      s.load(G.resolveURL(e.uri, t.path), i, void 0, function () {
        r(
    ...
    return (
      ...
      Promise.all(i).then(function (r) {
        const a = r[0],
          ...
          d =
            t.bufferView !== void 0
              ? s.bufferViews[t.bufferView].byteStride
              : void 0,
          p = t.normalized === !0;
        let R, m;
        if (d && d !== l) {
          ...
          let x = e.cache.get(_);
          x ||
            ((R = new c(a, T * d, (t.count * d) / u)),
            (x = new Fe(R, d / u)),
            e.cache.add(_, x)),
            (m = new sn(x, o, (h % d) / u, p));
        } else a === null ? (R = new c(t.count * o)) : (R = new c(a, h, t.count * o)), (m = new V(R, o, p));
        if (t.sparse !== void 0) {
          const T = q.SCALAR,
            _ = k[t.sparse.indices.componentType],
            x = t.sparse.indices.byteOffset || 0,
            E = t.sparse.values.byteOffset || 0,
            M = new _(r[1], x, t.sparse.count * T),
            N = new c(r[2], E, t.sparse.count * o);
          a !== null && (m = new V(m.array.slice(), m.itemSize, m.normalized)),
            (m.normalized = !1);
          for (let b = 0, H = M.length; b < H; b++) {
            const P = M[b];
            if (
              (m.setX(P, N[b * o]),
              o >= 2 && m.setY(P, N[b * o + 1]),
              o >= 3 && m.setZ(P, N[b * o + 2]),
              o >= 4 && m.setW(P, N[b * o + 3]),
              o >= 5)
            )
              throw new Error(
  ...
  loadTextureImage(n, e, s) {
    ...
    const c = this.loadImageSource(e, s)
      .then(function (u) {
        (u.flipY = !1),
          (u.name = r.name || a.name || ""),
          u.name === "" &&
            typeof a.uri == "string" &&
        ...
        return (
          (u.magFilter = ue[h.magFilter] || J),
          (u.minFilter = ue[h.minFilter] || Te),
          (u.wrapS = le[h.wrapS] || Z),
          (u.wrapT = le[h.wrapT] || Z),
          (u.generateMipmaps =
            !u.isCompressedTexture && u.minFilter !== Re && u.minFilter !== J),
          t.associations.set(u, { textures: n }),
          u
        );
      })
      .catch(function () {
      ...
      .then(function (l) {
        return new Promise(function (h, d) {
          ...
          e.isImageBitmapLoader === !0 &&
            ...
            e.load(G.resolveURL(l, i.path), p, void 0, d);
        });
      })
      .then(function (l) {
        return (
          ...
          S(l, r),
          (l.userData.mimeType = r.mimeType || Gn(r.uri)),
          l
        );
      })
      .catch(function (l) {
    ...
    return this.getDependency("texture", s.index).then(function (r) {
      ...
      if (
        ...
        if (a) {
          ...
          (r = i.extensions[g.KHR_TEXTURE_TRANSFORM].extendTexture(r, a)),
  ...
  loadMaterial(n) {
    ...
    if (o[g.KHR_MATERIALS_UNLIT]) {
      ...
      l.baseColorTexture !== void 0 &&
        c.push(e.assignTexture(a, "map", l.baseColorTexture, U)),
    ...
    if (
      (u === W.BLEND
        ...
        : ((a.transparent = !1),
          u === W.MASK &&
            (a.alphaTest = i.alphaCutoff !== void 0 ? i.alphaCutoff : 0.5)),
    ...
    if (
      ...
      i.emissiveFactor !== void 0 && r !== v)
    ) {
      const l = i.emissiveFactor;
      a.emissive = new F().setRGB(l[0], l[1], l[2], w);
    }
    return (
      i.emissiveTexture !== void 0 &&
        r !== v &&
        c.push(e.assignTexture(a, "emissiveMap", i.emissiveTexture, U)),
      Promise.all(c).then(function () {
        const l = new r(a);
        return (
          i.name && (l.name = i.name),
          S(l, i),
          e.associations.set(l, { materials: n }),
          i.extensions && O(t, l, i),
          l
        );
      })
    );
    ...
    return (
      ...
      Promise.all(a).then(function (o) {
        ...
        for (let d = 0, p = u.length; d < p; d++) {
          ...
          if (
            m.mode === L.TRIANGLES ||
            m.mode === L.TRIANGLE_STRIP ||
            m.mode === L.TRIANGLE_FAN ||
            m.mode === void 0
          )
            (T = i.isSkinnedMesh === !0 ? new Ve(R, _) : new Xe(R, _)),
              T.isSkinnedMesh === !0 && T.normalizeSkinWeights(),
              m.mode === L.TRIANGLE_STRIP
                ? (T.geometry = oe(T.geometry, he))
                : m.mode === L.TRIANGLE_FAN && (T.geometry = oe(T.geometry, Q));
          else if (m.mode === L.LINES) T = new ze(R, _);
          else if (m.mode === L.LINE_STRIP) T = new qe(R, _);
          else if (m.mode === L.LINE_LOOP) T = new We(R, _);
          else if (m.mode === L.POINTS) T = new Ye(R, _);
          else
            throw new Error(
              "THREE.GLTFLoader: Primitive mode unsupported: " + m.mode
            );
          Object.keys(T.geometry.morphAttributes).length > 0 && Dn(T, i),
            (T.name = e.createUniqueName(i.name || "mesh_" + n)),
            S(T, i),
            m.extensions && O(t, T, m),
            e.assignFinalMaterial(T),
            l.push(T);
        }
        for (let d = 0, p = l.length; d < p; d++)
          e.associations.set(l[d], { meshes: n, primitives: d });
        if (l.length === 1) return i.extensions && O(t, l[0], i), l[0];
        const h = new z();
        i.extensions && O(t, h, i), e.associations.set(h, { meshes: n });
        for (let d = 0, p = l.length; d < p; d++) h.add(l[d]);
        return h;
      })
    );
  }
  loadCamera(n) {
    ...
    return (
      s.type === "perspective"
        ...
        : s.type === "orthographic" &&
          (e = new Ze(-t.xmag, t.xmag, t.ymag, -t.ymag, t.znear, t.zfar)),
  ...
  loadAnimation(n) {
    ...
    for (let l = 0, h = t.channels.length; l < h; l++) {
      const d = t.channels[l],
        p = t.samplers[d.sampler],
        R = d.target,
        m = R.node,
        T = t.parameters !== void 0 ? t.parameters[p.input] : p.input,
        _ = t.parameters !== void 0 ? t.parameters[p.output] : p.output;
      R.node !== void 0 &&
    ...
    return Promise.all([
      ...
      for (let x = 0, E = h.length; x < E; x++) {
        ...
        const B = s._createAnimationTracks(M, N, b, H, P);
        if (B) for (let j = 0; j < B.length; j++) T.push(B[j]);
      }
      const _ = new en(i, void 0, T);
      return S(_, t), _;
    });
  }
  createNodeMesh(n) {
    ...
    return t.mesh === void 0
      ? null
      : s.getDependency("mesh", t.mesh).then(function (i) {
  ...
  loadNode(n) {
    ...
    const o =
      t.skin === void 0
        ...
        : s.getDependency("skin", t.skin);
    return Promise.all([i, Promise.all(r), o]).then(function (c) {
      const u = c[0],
        l = c[1],
        h = c[2];
      h !== null &&
      ...
      if (u.userData.pivot !== void 0 && l.length > 0) {
        const d = u.userData.pivot,
          p = l[0];
        (u.pivot = new C().fromArray(d)),
          (u.position.x -= d[0]),
          (u.position.y -= d[1]),
          (u.position.z -= d[2]),
  ...
  _loadNodeShallow(n) {
    ...
    const i = e.nodes[n],
      r = i.name ? t.createUniqueName(i.name) : "",
      a = [],
    ...
    return (
      ...
      i.camera !== void 0 &&
        a.push(
          t.getDependency("camera", i.camera).then(function (c) {
      ...
      (this.nodeCache[n] = Promise.all(a).then(function (c) {
        ...
        if (
          ...
          for (let l = 0, h = c.length; l < h; l++) u.add(c[l]);
        if (
          (i.name && ((u.userData.name = i.name), (u.name = r)),
          S(u, i),
          i.extensions && O(s, u, i),
          i.matrix !== void 0)
        ) {
          const l = new K();
        ...
        if (!t.associations.has(u)) t.associations.set(u, {});
  ...
  loadScene(n) {
    const e = this.extensions,
      s = this.json.scenes[n],
      t = this,
      i = new z();
    s.name && (i.name = t.createUniqueName(s.name)),
      S(i, s),
      s.extensions && O(e, i, s);
    const r = s.nodes || [],
      a = [];
    for (let o = 0, c = r.length; o < c; o++)
  ...
  _createAnimationTracks(n, e, s, t, i) {
    ...
    I[i.path] === I.weights
      ? (c(n), n.isGroup && n.children.forEach(c))
      : o.push(a);
    let u;
    switch (I[i.path]) {
      case I.weights:
    ...
    const l = t.interpolation !== void 0 ? Pn[t.interpolation] : xe,
      h = this._getArrayFromAccessor(s);
    for (let d = 0, p = o.length; d < p; d++) {
      const R = new u(o[d] + "." + I[i.path], e.array, h, l);
  ...
  _getArrayFromAccessor(n) {
    let e = n.array;
    if (n.normalized) {
      const s = ee(e.constructor),
        t = new Float32Array(e.length);
      for (let i = 0, r = e.length; i < r; i++) t[i] = e[i] * s;
      e = t;
    }
    return e;
  }
...
function Bn(f, n, e) {
  ...
  if (s.POSITION !== void 0) {
    ...
    if (o !== void 0 && c !== void 0) {
      if (
        (t.set(new C(o[0], o[1], o[2]), new C(c[0], c[1], c[2])), a.normalized)
      ) {
    ...
    for (let c = 0, u = i.length; c < u; c++) {
      ...
      if (l.POSITION !== void 0) {
        ...
        if (d !== void 0 && p !== void 0) {
          if (
            (o.setX(Math.max(Math.abs(d[0]), Math.abs(p[0]))),
            o.setY(Math.max(Math.abs(d[1]), Math.abs(p[1]))),
            o.setZ(Math.max(Math.abs(d[2]), Math.abs(p[2]))),
            h.normalized)
          ) {
  ...
  f.boundingBox = t;
  const r = new cn();
  t.getCenter(r.center),
    (r.radius = t.min.distanceTo(t.max) / 2),
    (f.boundingSphere = r);
}
function fe(f, n, e) {
  const s = n.attributes,
